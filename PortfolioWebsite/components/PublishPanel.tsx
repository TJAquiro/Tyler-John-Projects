...
export function PublishPanel({ draft, busy: saving, flush, connect, openAccount, onPublished, restore, signedOut, onBusy, deleteAccount }: {
  ...
  return <section onChange={() => { setError(""); setStatus(""); }} className="space-y-6" aria-labelledby="publish-heading"><div><p className="eyebrow">Ready to share</p><h2 id="publish-heading" className="display mt-3 text-3xl">Publish your portfolio.</h2><p className="mt-3 leading-7 text-moss">Publishing uploads a copy of your work. Future edits stay on this device until you publish updates.</p></div>
