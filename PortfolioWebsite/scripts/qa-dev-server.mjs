...
const child=spawn(process.execPath,[path.resolve("node_modules/next/dist/bin/next"),"dev","--hostname","127.0.0.1","--port","3101"],{env:{...process.env,PORTFOLIO_CONTENT_DIR:content,PORTFOLIO_ACCOUNT_DIR:accounts,PORTFOLIO_BUILD_DIR:".next-qa-dev",SESSION_SECRET:"qa-dev-session-secret",NEXT_TELEMETRY_DISABLED:"1",VERCEL:"0"},stdio:"inherit",windowsHide:true});
