...
public class Transaction implements Comparable<Transaction>
{
    ...
    /**
     * Turns the Transaction into a string.
     * @return String showing the sender, receiver, amount, and fee.
     */
     ...
     * @return int the cost of the Transaction
     */
    public int getFee()
    {
        return fee;
	...
	/**
     * Compares two Transaction objects by their fee.
     * @param o Another Transaction object.
     * @return int showing whether the amount was equal greater or less.
     */
	@Override
