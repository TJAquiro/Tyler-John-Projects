...
public class Game
{
    ...
    */
    ...
    public static void main(String args[])
    {
        ...
        */
        Field<Block> field2 = FieldGenerator.randomIntegers(10,10,1,9,5);
    ...
    /**
	    * Finds the best starting position that has the best route through the field with the most points
	    *
	    * @param field, a field object
	    * @return TwoValues, contains the best starting point, and the amount of points in the best route
	    * */
    ...
    public static TwoValues bestStartingPoint(Field field)
    {
    	...
    	for(int x = 0;x < field.getWidth(); ++x)
    	{
    		...
    		//uses recursive() to find the route with the most points in that starting position
    		...
    		//if this starting has more points that the last starting positions, that becomes the maxStarting
    ...
    /**
	    * Given a startingColumn the best route through the field is returned
	    *
	    * @param field, a field object
	    * @param startingColumn, where on the field to start (assuming we will be on the first row)
	    * @return ArrayList<Block>, made up of the blocks that the recursion passed though that netted the most points 
	    * */
    
    public static ArrayList<Block> bestRoute(Field field, int startingColumn)
    {
    	//uses recursive to find the best route given a specific startingColumn
    ...
    /**
	    * Recursively iterates down the field, compares paths, if one path has more then the others that path is kept and the others are tossed 
	    *
	    * @param field, a field object
	    * @param currentRow, which row of the field we are in
	    * @param currentCol, which row of the field we are in
	    * @return ArrayList<Block>, made up of the blocks that the recursion passed though that netted the most points 
	    * */
    ...
    private static ArrayList<Block> recursive(Field field, int currentRow, int currentCol)
    {
    	...
    	if(currentRow + 2 == field.getHeight()) //on the second to last row
    	{
    		...
    		//compares left right and middle paths
    		
    		Block maxLeaf = findMaxOf2Blocks(right, findMaxOf2Blocks(mid, left));
    		
    		//which ever path has the highest points is added to an array
    ...
    /**
	    * Helper method for comparing 2 block objects and returning which ever is higher
	    *
	    * @param Block x, the first block being compared
	    * @param Block y, the second block being compared
	    * 
	    * @return Block, which ever is higher of the two params
	    * */
    ...
    /**
	    * Helper method for adding all the points of the blocks in two block arrays and returns the array with the most points
	    *
	    * @param a, the first ArrayList being compared
	    * @param b, the second ArrayList being compared
	    * 
	    * @return ArrayList<Block>, which ever has the most points
	    * */
