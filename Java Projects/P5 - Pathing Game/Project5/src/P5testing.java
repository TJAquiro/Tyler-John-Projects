...
public class P5testing
{
    ...
    */
    ...
    {
    	Field<String> ff = new Field<String>(1,1);
    	
    	ff.setElement(0, 0, "hi");
        ...
        */
        Field<Block> field2 = FieldGenerator.randomIntegers(8,11,0,9,10);
        ...
        */
        ...
        System.out.println("im printing start");
        for(Block b:field)
            System.out.println(b);
        System.out.println("im printing end");
