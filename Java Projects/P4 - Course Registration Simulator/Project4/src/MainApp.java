...
public class MainApp {
	...
	public static void main(String[] args) throws Exception {
		...
		{// Test Case 3
			...
			Set<MeetDay> meetDays2 = new HashSet<MeetDay>();
			...
			Course c1 = new OnlineCourse("CRN1", "AOP12345678910111213", levels, "Mr John1", 5, meetDays, gtas);
			Course c2 = new OnlineCourse("CRN2", "Bntro to OOP12345678910111213", levels, "Mr John2", 5, meetDays, gtas);
			Course c3 = new OnlineCourse("CRN3", "Clgorithms12345678910111213", levels, "Mr John3", 5, meetDays, gtas);
			Course c4 = new OnlineCourse("CRN4", "Data Structure12345678910111213", levels, "Mr John4", 5, meetDays2, gtas);
			Course c5 = new OnlineCourse("CRN5", "Fata Analysis12345678910111213", levels, "Mr John5", 5, meetDays, gtas);
			Course c6 = new OnlineCourse("CRN6", "Fata Analysis12345678910111213", levels, "Mr John6", 5, meetDays2, gtas);
