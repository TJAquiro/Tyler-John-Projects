...
public class P2tester
{
	...
	public static void main (String [] args)
	{
		...
		*/
		...
		Adult at1 = new Adult("name1", "1232/02/22", "987-65-4320", 10000.0f, "GMU");
		Child ct1 = new Child("kid1", "1200/01/01", "999-65-1110", 0.0f, "FHS", 3300.0f);
		
		Family f1 = new Family((byte)1, (byte)3);
		f1.addMember(at1);
		
		System.out.println("here " + at1.taxWithheld());
		
		System.out.println(f1.getTaxableIncome());
		System.out.println(f1.getFilingStatus());
		System.out.println(taxation.maxIncomeTaxBracket(f1));
		System.out.println(taxation.amountTakenFromBrakets(f1));
		System.out.println(f1.calculateTax());
		
		System.out.println("--" + at1.getGrossIncome());
		System.out.println("--" + at1.adjustedIncome());
		System.out.println(taxation.amountTakenFromBrakets(f1));
		*/
		...
		System.out.println("first  " + a3.taxWithheld());
		...
		System.out.println("withheld "+y.taxWithheld()); // returns 142866.65
